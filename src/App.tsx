...
import VolunteerSimple from "./pages/VolunteerSimple";
    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/volunteer" element={<Layout><VolunteerSimple /></Layout>} />
          <Route path="/volunteer-advanced" element={<Layout><Volunteer /></Layout>} />
